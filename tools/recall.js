...
exports.memosRecallTool = memosRecallTool;
exports.memosCrossDeptTool = memosCrossDeptTool;
 ...
 */
async function memosRecallTool(params, ctx, config, client) {
    try {
        // Resolve department
 ...
 * @returns Search results
 */
async function memosCrossDeptTool(params, ctx, config, client) {
    try {
